...
def MultiProcess1(Environment, inputList, startPriceList, endPriceList, stockList, day):
    print "day " + str(day)
...
# Start loop of days and generations     
    ...
    for gen in range(genCount):
        pool = mp.Pool(100)
        partial_day_func = partial(MultiProcess1,Environment, inputList, startPriceList, endPriceList, stockList)
